(function(b){var n={type:"text",width:400,height:300,spinner:{speed:100,segments:8},css:{shadow:{"background-color":"black",opacity:0.8,position:"fixed",left:0,top:0,bottom:0,right:0,"z-index":1E3},modal:{"background-color":"black",color:"white",padding:10,position:"fixed","z-index":1001,border:"5px solid white","border-radius":10,"-moz-border-radius":10,"-webkit-border-radius":10,"box-shadow":"0 0 10px #fff","-moz-box-shadow":"0 0 10px #fff","-webkit-box-shadow":"0 0 10px #fff"},close_button:{cursor:"pointer",
